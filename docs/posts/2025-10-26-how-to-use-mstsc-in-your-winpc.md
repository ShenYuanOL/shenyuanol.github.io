...
slug: how-to-use-mstsc-in-your-winpc
date: '2025-10-26 19:17:14'
description: >-
  前言 你是否像曾经的我一样 “windows如何使用远程桌面” “局域网内如何使用微软远程桌面” “外网如何使用远程桌面” “如何配置我的远程桌面ip”
  ...... 在这篇文章你将学会： 配置远程桌面IP 学会使用樱花FRP映射 内/外网
tags:
  - 未分类
layout: essay
...
2. 在这个界面点击选择“Internet协议版本4”
 ![Internet](/images/how-to-use-mstsc-in-your-winpc/Internet.png)
 ![Internet4](/images/how-to-use-mstsc-in-your-winpc/Internet4.png)
...
```
3. 将以上内容像下图这样填写进去
![InternetUpdata](/images/how-to-use-mstsc-in-your-winpc/InternetUpdata.png)
4. 点击确认保存
...
### 控制端
打开微软远程桌面
![mstsc](/images/how-to-use-mstsc-in-your-winpc/mstsc.png)
输入上边需要记住的“IVP4”地址，然后回车，在这个界面输入账户和密码，然后回车
![mstscPaw](/images/how-to-use-mstsc-in-your-winpc/mstscPaw.png)
